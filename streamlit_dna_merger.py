...
st.write("""
Paste FASTA sequences below in order from the 5' end of the first sequence to the 3' end of the last sequence. If a sequence is in the antisense direction, specify it in the header by adding 'antisense' after the sequence name.
Example:
```
>sequence1
ATGCGTACGTTAGC
